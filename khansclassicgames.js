            ...
            for(var l = 0; l<board.length; l++){
                for(var i = 0; i<board[l].length; i++){
                    if(mouseX<=board[l][i][1] + 75 && mouseX>=board[l][i][1] && mouseY<=board[l][i][2] + 75 && mouseY>=board[l][i][2] && board[l][i][5] === "light"){
                        ...
                        //takes checker non-king
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selected === true && selectedColor === "black" && selectedRank === 1 && selectedRow < 6 && (board[l][i] === board[selectedColumn+1][selectedRow+1] || board[l][i] === board[selectedColumn+1][selectedRow-1]) && (board[selectedColumn+2][selectedRow+2][0] === "_" || board[selectedColumn+2][selectedRow-2][0] === "_") && turn === "black"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow+1] && board[selectedColumn+2][selectedRow+2][0] === "_"){
                                ...
                                selectedRow = null;
                                turn = "red";
                                while(((board[newPosX+1][newPosY+1][0] === "L" || board[newPosX+1][newPosY+1][0] === "LK") && board[newPosX+2][newPosY+2][0] === "_") || ((board[newPosX+1][newPosY-1][0] === "L" || board[newPosX+1][newPosY-1][0] === "L") && board[newPosX+2][newPosY-2][0] === "_")){
                                    if((board[newPosX+1][newPosY+1][0] === "L" || board[newPosX+1][newPosY+1][0] === "LK") && board[newPosX+2][newPosY+2][0] === "_"){
                                    ...
                                    else if((board[newPosX+1][newPosY-1][0] === "L" || board[newPosX+1][newPosY-1][0] === "L") && board[newPosX+2][newPosY-2][0] === "_"){
                                        board[newPosX+1][newPosY-1][0] = "_";
                                        board[newPosX+2][newPosY-2][0] = "D";
                                        board[newPosX][newPosY][0] = "_";
                                        newPosX += 2;
                                ...
                                selectedRow = null;
                                turn = "red";
                                while(((board[newPosX+1][newPosY+1][0] === "L" || board[newPosX+1][newPosY+1][0] === "LK") && board[newPosX+2][newPosY+2][0] === "_") || ((board[newPosX+1][newPosY-1][0] === "L" || board[newPosX+1][newPosY-1][0] === "LK") && board[newPosX+2][newPosY-2][0] === "_")){
                                    if((board[newPosX+1][newPosY+1][0] === "L" || board[newPosX+1][newPosY+1][0] === "LK") && board[newPosX+2][newPosY+2][0] === "_"){
                                        board[newPosX+1][newPosY+1][0] = "_";
                                        board[newPosX+2][newPosY+2][0] = "D";
                                        board[newPosX][newPosY][0] = "_";
                                    ...
                                    else if((board[newPosX+1][newPosY-1][0] === "L" || board[newPosX+1][newPosY-1][0] === "LK") && board[newPosX+2][newPosY-2][0] === "_"){
                                        board[newPosX+1][newPosY-1][0] = "_";
                                        board[newPosX+2][newPosY-2][0] = "D";
                                        board[newPosX][newPosY][0] = "_";
                                        newPosX += 2;
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selected === true && selectedColor === "black" && selectedRank === 1 && selectedRow === 6 && board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_" && turn === "black"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "D";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selected === true && selectedColor === "black" && selectedRank === 1 && selectedRow === 7 && board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_" && turn === "black"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "D";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selected === true && selectedColor === "red" && selectedRank === 1 && selectedRow < 6 && (board[l][i] === board[selectedColumn-1][selectedRow+1] || board[l][i] === board[selectedColumn-1][selectedRow-1]) && (board[selectedColumn-2][selectedRow+2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "red"){
                            if(board[l][i] === board[selectedColumn-1][selectedRow+1] && board[selectedColumn-2][selectedRow+2][0] === "_"){
                                ...
                                selectedRow = null;
                                turn = "black";
                                while(((board[newPosX-1][newPosY+1][0] === "D" || board[newPosX-1][newPosY+1][0] === "DK") && board[newPosX-2][newPosY+2][0] === "_") || ((board[newPosX-1][newPosY-1][0] === "D" || board[newPosX-1][newPosY-1][0] === "DK") && board[newPosX-2][newPosY-2][0] === "_")){
                                    if((board[newPosX-1][newPosY+1][0] === "D" || board[newPosX-1][newPosY+1][0] === "DK") && board[newPosX-2][newPosY+2][0] === "_"){
                                        board[newPosX-1][newPosY+1][0] = "_";
                                    ...
                                    else if((board[newPosX-1][newPosY-1][0] === "D" || board[newPosX-1][newPosY-1][0] === "DK") && board[newPosX-2][newPosY-2][0] === "_"){
                                        board[newPosX-1][newPosY-1][0] = "_";
                                        board[newPosX-2][newPosY-2][0] = "L";
                                        board[newPosX][newPosY][0] = "_";
                                        newPosX -= 2;
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selected === true && selectedColor === "red" && selectedRank === 1 && selectedRow === 6 && board[l][i] === board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_" && turn === "red"){
                            if(board[l][i] === board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_"){
                                board[selectedColumn-2][selectedRow-2][0] = "L";
                                board[selectedColumn-1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selected === true && selectedColor === "red" && selectedRank === 1 && selectedRow === 7 && board[l][i] === board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_" && turn === "red"){
                            if(board[l][i] === board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_"){
                                board[selectedColumn-2][selectedRow-2][0] = "L";
                                board[selectedColumn-1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        //takes checker king
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selectedRank === 2 && selected === true && selectedColumn < 6 && selectedRow < 6 && selectedColor === "black" && (board[l][i] === board[selectedColumn+1][selectedRow+1] || board[l][i] === board[selectedColumn+1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow+1]) && (board[selectedColumn+2][selectedRow+2][0] === "_" || board[selectedColumn+2][selectedRow-2][0] === "_" || board[selectedColumn-2][selectedRow+2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "black"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow+1] && board[selectedColumn+2][selectedRow+2][0] === "_"){
                                ...
                                selectedRow = null;
                                turn = "red";
                                while(((board[newPosX+1][newPosY+1][0] === "L" || board[newPosX+1][newPosY+1][0] === "LK") && board[newPosX+2][newPosY+2][0] === "_") || ((board[newPosX+1][newPosY-1][0] === "L" || board[newPosX+1][newPosY-1][0] === "LK") && board[newPosX+2][newPosY-2][0] === "_") || ((board[newPosX-1][newPosY+1][0] === "L" || board[newPosX-1][newPosY+1][0] === "LK") && board[newPosX-2][newPosY+2][0] === "_") || ((board[newPosX-1][newPosY-1][0] === "L" || board[newPosX-1][newPosY-1][0] === "LK") && board[newPosX-2][newPosY-2][0] === "_")){
                                    if((board[newPosX+1][newPosY+1][0] === "L" || board[newPosX+1][newPosY+1][0] === "LK") && board[newPosX+2][newPosY+2][0] === "_"){
                                        board[newPosX+1][newPosY+1][0] = "_";
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selectedRank === 2 && selected === true && selectedColumn < 6 && selectedRow === 6 && selectedColor === "black" && (board[l][i] === board[selectedColumn+1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow-1]) && (board[selectedColumn+2][selectedRow-2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "black"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "DK";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selectedRank === 2 && selected === true && selectedColumn < 6 && selectedRow === 7 && selectedColor === "black" && (board[l][i] === board[selectedColumn+1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow-1]) && (board[selectedColumn+2][selectedRow-2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "black"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "DK";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selectedRank === 2 && selected === true && selectedColumn === 6 && selectedRow === 6 && selectedColor === "black" && board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_" && turn === "black"){
                            if(board[l][i] === board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_"){
                                board[selectedColumn-2][selectedRow-2][0] = "DK";
                                board[selectedColumn-1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selectedRank === 2 && selected === true && selectedColumn === 7 && selectedRow < 6 && selectedColor === "black" && (board[l][i] === board[selectedColumn-1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow+1]) && (board[selectedColumn-2][selectedRow+2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "black"){
                            if(board[l][i] === board[selectedColumn-1][selectedRow+1] && board[selectedColumn-2][selectedRow+2][0] === "_"){
                                board[selectedColumn-2][selectedRow+2][0] = "DK";
                                board[selectedColumn-1][selectedRow+1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "L" || board[l][i][0] === "LK") && selectedRank === 2 && selected === true && selectedColumn === 7 && selectedRow === 7 && selectedColor === "black" && board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_" && turn === "black"){
                            if(board[l][i] === board[selectedColumn-1][selectedRow-1] && board[selectedColumn-2][selectedRow-2][0] === "_"){
                                board[selectedColumn-2][selectedRow-2][0] = "DK";
                                board[selectedColumn-1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selectedRank === 2 && selected === true && selectedColor === "red" && selectedColumn > 1 && selectedRow < 6 && (board[l][i] === board[selectedColumn+1][selectedRow+1] || board[l][i] === board[selectedColumn+1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow+1]) && (board[selectedColumn+2][selectedRow+2][0] === "_" || board[selectedColumn+2][selectedRow-2][0] === "_" || board[selectedColumn-2][selectedRow+2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "red"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow+1] && board[selectedColumn+2][selectedRow+2][0] === "_"){
                                ...
                                selectedRow = null;
                                turn = "black";
                                while(((board[newPosX+1][newPosY+1][0] === "D" || board[newPosX+1][newPosY+1][0] === "DK") && board[newPosX+2][newPosY+2][0] === "_") || ((board[newPosX+1][newPosY-1][0] === "D" || board[newPosX+1][newPosY-1][0] === "DK") && board[newPosX+2][newPosY-2][0] === "_") || ((board[newPosX-1][newPosY+1][0] === "D" || board[newPosX-1][newPosY+1][0] === "DK") && board[newPosX-2][newPosY+2][0] === "_") || ((board[newPosX-1][newPosY-1][0] === "D" || board[newPosX-1][newPosY-1][0] === "DK") && board[newPosX-2][newPosY-2][0] === "_")){
                                    if((board[newPosX+1][newPosY+1][0] === "D" || board[newPosX+1][newPosY+1][0] === "DK") && board[newPosX+2][newPosY+2][0] === "_"){
                                        board[newPosX+1][newPosY+1][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selectedRank === 2 && selected === true && selectedColor === "red" && selectedColumn > 1 && selectedRow === 6 && (board[l][i] === board[selectedColumn+1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow-1]) && (board[selectedColumn+2][selectedRow-2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "red"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "LK";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selectedRank === 2 && selected === true && selectedColor === "red" && selectedColumn > 1 && selectedRow === 7 && (board[l][i] === board[selectedColumn+1][selectedRow-1] || board[l][i] === board[selectedColumn-1][selectedRow-1]) && (board[selectedColumn+2][selectedRow-2][0] === "_" || board[selectedColumn-2][selectedRow-2][0] === "_") && turn === "red"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "LK";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selectedRank === 2 && selected === true && selectedColor === "red" && selectedColumn === 1 && selectedRow === 7 && board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_" && turn === "red"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "LK";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selectedRank === 2 && selected === true && selectedColor === "red" && selectedColumn === 0 && selectedRow < 6 && (board[l][i] === board[selectedColumn+1][selectedRow+1] || board[l][i] === board[selectedColumn+1][selectedRow-1]) && (board[selectedColumn+2][selectedRow+2][0] === "_" || board[selectedColumn+2][selectedRow-2][0] === "_") && turn === "red"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow+1] && board[selectedColumn+2][selectedRow+2][0] === "_"){
                                board[selectedColumn+2][selectedRow+2][0] = "LK";
                                board[selectedColumn+1][selectedRow+1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
                        ...
                        else if((board[l][i][0] === "D" || board[l][i][0] === "DK") && selectedRank === 2 && selected === true && selectedColor === "red" && selectedColumn === 0 && selectedRow === 6 && board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_" && turn === "red"){
                            if(board[l][i] === board[selectedColumn+1][selectedRow-1] && board[selectedColumn+2][selectedRow-2][0] === "_"){
                                board[selectedColumn+2][selectedRow-2][0] = "LK";
                                board[selectedColumn+1][selectedRow-1][0] = "_";
                                board[selectedColumn][selectedRow][0] = "_";
